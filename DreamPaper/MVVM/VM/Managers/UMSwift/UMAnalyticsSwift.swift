...
//     @return void.
//     */
//    static func event(_ event: NaduoEvent) {
//        MobClick.event(event.rawValue)
//    }
//    
//    enum NaduoEvent: String {
//        /// 创建云朵
//        case createCloud = "nd_001"
//        
//        /// 完成创建云朵
//        case completeCreateCloud = "nd_002"
//        
//        /// 点击编辑生平
//        case clickEditBiography = "nd_003"
//        
//        /// 点击邀请亲友
//        case clickInviteFriends = "nd_004"
//        
//        /// 弹出付款页面
//        case showPaymentPage = "nd_005"
//        
//        /// 点击付款按钮
//        case clickPaymentButton = "nd_006"
//        
//        /// 进入登录页面
//        case enterLoginPage = "nd_login_1"
//        
//        /// 完成登录
//        case completeLogin = "nd_login_2"
//        
//        /// 完成新用户资料填写
//        case completeNewUserInformation = "nd_login_3"
//        
//        /// 点击主页面添加回忆按钮
//        case clickAddMemoryButton = "nd_007"
//        
//        /// 打开云朵详情
//        case openCloudDetails = "nd_cloud_1"
//    }
//
//    /** 自定义事件,数量统计.
//     使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
...
//        return MobClick.getPreProperties() as! [String: Any]
//    }
//
//    /**
//     *清空所有预置事件属性。
